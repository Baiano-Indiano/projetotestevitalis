...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
