...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/__l5e/assets-v1/09c0e45c-a266-49e1-8dfb-4fdb08dd4b45/vitalis-logo.jpg" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "/__l5e/assets-v1/09c0e45c-a266-49e1-8dfb-4fdb08dd4b45/vitalis-logo.jpg" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/jpeg", href: "/__l5e/assets-v1/09c0e45c-a266-49e1-8dfb-4fdb08dd4b45/vitalis-logo.jpg" },
      { rel: "shortcut icon", type: "image/jpeg", href: "/__l5e/assets-v1/09c0e45c-a266-49e1-8dfb-4fdb08dd4b45/vitalis-logo.jpg" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/09c0e45c-a266-49e1-8dfb-4fdb08dd4b45/vitalis-logo.jpg" },
