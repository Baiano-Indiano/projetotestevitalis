...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://projetotestevitalis.lovable.app/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
      { property: "og:url", content: "https://projetotestevitalis.lovable.app/" },
      { property: "og:site_name", content: "Vitalis Belém" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "https://projetotestevitalis.lovable.app/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
      { name: "twitter:title", content: "Vitalis. Saúde pública veterinária de Belém" },
      { name: "twitter:description", content: "Triagem online gratuita e atendimento na rede veterinária municipal de Belém." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "VeterinaryCare",
          name: "Vitalis — Hospital Veterinário Público de Belém",
          description:
            "Rede pública municipal de atendimento veterinário com triagem online, agendamento e acompanhamento clínico.",
          url: "https://projetotestevitalis.lovable.app/",
          areaServed: { "@type": "City", name: "Belém", addressRegion: "PA", addressCountry: "BR" },
          medicalSpecialty: "Veterinary",
          provider: {
            "@type": "GovernmentOrganization",
            name: "Prefeitura Municipal de Belém",
          },
          location: [
            {
              "@type": "AnimalShelter",
              name: "Hospital Veterinário Municipal — Unidade Central",
              address: {
                "@type": "PostalAddress",
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
      { rel: "shortcut icon", type: "image/png", href: "/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/fb7bc72a-d7d0-4275-af3b-c499d9bbd1a0/vitalis-logo.png" },
