...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/__l5e/assets-v1/3687325f-3e59-4f43-b14b-423611e92eae/vitalis-logo.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "/__l5e/assets-v1/3687325f-3e59-4f43-b14b-423611e92eae/vitalis-logo.png" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/jpeg", href: "/__l5e/assets-v1/3687325f-3e59-4f43-b14b-423611e92eae/vitalis-logo.png" },
      { rel: "shortcut icon", type: "image/jpeg", href: "/__l5e/assets-v1/3687325f-3e59-4f43-b14b-423611e92eae/vitalis-logo.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/3687325f-3e59-4f43-b14b-423611e92eae/vitalis-logo.png" },
